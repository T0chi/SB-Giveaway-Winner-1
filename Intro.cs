...
namespace StorybrewScripts
{
    ...
    public class Intro : StoryboardObjectGenerator
    {
        ...
        [Configurable]
        public Color4 TochiColor = Color4.Cyan;
        ...
        public void Credits()
        {
            ...
            var credits3 = GetLayer("Credits").CreateSprite("sb/credits/hitsound.png", OsbOrigin.TopCentre);
        ...
        public void Avatars()
        {
            ...
            Tochi(320, 430, 0.8f, 1860, HoverEndTime, duration, (int)HoverLoopCount, HoverDuration, HoverVelocity);
        ...
        public void Tochi(float posX, float posY, float Fade, int startTime, int endTime, int duration, int LoopCount, int HoverDuration, int HoverVelocity)
        {
            ...
            var light = GetLayer("-Tochi").CreateSprite("sb/light3.png", OsbOrigin.BottomCentre);
            ...
            avatar.Color(startTime, TochiColor);
            ...
            // nameTag.Color(startTime, TochiColor);

            // light
            light.MoveY(startTime, posY + HoverVelocity);
            light.MoveX(startTime, posX);
            light.MoveX(OsbEasing.InOutSine, 12937, 15707, posX, posX - 150);
            light.ScaleVec(startTime, 0.4f, 0.7f);
            light.Additive(startTime, endTime);
            light.Fade(startTime, startTime + (HoverDuration / 2), 0, Fade);
            light.Fade(endTime - (HoverDuration / 2), endTime, Fade, 0);
            
            var startRotation = MathHelper.DegreesToRadians(-2);
            var endRotation = MathHelper.DegreesToRadians(2);

            var loopCount = ((endTime - (HoverDuration / 2)) - (startTime + (HoverDuration / 2))) / HoverDuration;
            light.StartLoopGroup(startTime + (HoverDuration / 2), loopCount);
            light.Fade(0, (HoverDuration / 2), Fade, Fade / 2);
            light.Fade((HoverDuration / 2), HoverDuration, Fade / 2, Fade);
            light.EndGroup();

            var loopCount2 = (endTime - startTime) / HoverDuration;
            light.StartLoopGroup(startTime, loopCount2);
            light.Rotate(OsbEasing.InOutSine, 0, (HoverDuration / 2), startRotation, endRotation);
            light.Rotate(OsbEasing.InOutSine, (HoverDuration / 2), HoverDuration, endRotation, startRotation);
            light.EndGroup();
            ...
            avatarReflection.FlipH(startTime, endTime);
            avatarReflection.MoveX(OsbEasing.InOutSine, 12937, 15707, posX, posX - 150);
            avatarReflection.Scale(startTime, 0.50);
