...
public class HUD
{
    ...
    public void DialogNarrator(int startTime, int endTime, string Mission, string SongName)
    {
        ...
        var dialog = new DialogManager(generator, font, startTime + 924, startTime + 8077, "HUD", 320, 290, true,
            fontSize, 0.2f, Color4.White, false, 0.7f, Color4.Black, "HUD", 0, "sb/sfx/message-2.wav",
        ...
        var dialog3 = new DialogManager(generator, font, startTime + 10154, startTime + 11378, "HUD", 320, 290, true,
            fontSize, 0.5f, Color4.White, false, 0.7f, Color4.Black, "HUD", 300, "sb/sfx/start-2.wav",
