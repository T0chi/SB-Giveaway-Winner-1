        ...
        for (int time = startTime; time < endTime; time += timeStepBalloon)
        {
            ...
            if (balloonScale <= 0.27)
            {
                ...
                for (var i = 0; i < balloonPopCount; i++)
                {
                    ...
                    var balloonPopSound = generator.GetLayer("targetBalloonsBack").CreateSample("sb/sfx/balloon-pop.wav", time + balloonDuration, 7);
                ...
                var arrowSound = generator.GetLayer("Arrows").CreateSample("sb/sfx/arrow-1.wav", time + balloonDuration - arrowSpeed, 70);
            ...
            else
            {
                ...
                for (var i = 0; i < balloonPopCount; i++)
                {
                    ...
                    var balloonPopSound = generator.GetLayer("targetBalloonsFront").CreateSample("sb/sfx/balloon-pop.wav", time + balloonDuration, 12);
                ...
                var arrowSound = generator.GetLayer("Arrows").CreateSample("sb/sfx/arrow-1.wav", time + balloonDuration - arrowSpeed, 100);
